...
for index_type in index_types:
    try:
        ...
        # Save predictions
        evaluation.save_single_prediction(prediction_time, prediction_path, "pred_times")
        evaluation.save_single_prediction(search_time, prediction_path, "search_times")
        evaluation.save_single_prediction(total_time, prediction_path, "total_times")
        evaluation.save_single_prediction(prediction_reads, prediction_path, "reads")
